...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            RaycastHit hitInfo;
            if (Physics.SphereCast(transform.position, m_Capsule.size * (1.0f - advancedSettings.shellOffset), Vector3.down, out hitInfo,
                                   ((m_Capsule.size/2f) - m_Capsule.size) +
